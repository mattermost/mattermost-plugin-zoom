...
You can ignore the "Verification Code" on this page, as we are using a secret generated by Mattermost instead. We'll select the webhook events in the next step.`
)
