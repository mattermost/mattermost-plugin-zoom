...
We're going to set the **OAuth ClientID** and **OAuth Secret**, generated by Zoom and used to create meetings and pull user data:
...
In order to comply with Zoom’s commitment to security and the protection of user data, this plugin allows users to be deauthorized directly from Zoom. If you **would like to publish on Zoom Marketplace**, you'll be able to set up a Deauthorization URL.
