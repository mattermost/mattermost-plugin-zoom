...
func findManifest() (*LocalManifest, error) {
...
func dumpPluginID(manifest *LocalManifest) {
	fmt.Printf("%s", manifest.Id)
}

// dumpPluginVersion writes the plugin version from the given manifest to standard out
func dumpPluginVersion(manifest *LocalManifest) {
	fmt.Printf("%s", manifest.Version)
}

// applyManifest propagates the plugin_id into the server and webapp folders, as necessary
func applyManifest(manifest *LocalManifest) error {
	if manifest.HasServer() {
		//nolint:gosec
